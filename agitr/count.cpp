// This program p e r iod i ca l l y generates log messages at
// various s e v e r i ty l e v e l s .
...
int main ( int argc , char **argv ) {
    ...
    // Generate log messages of varying s e v e r i ty re gu la r ly .
